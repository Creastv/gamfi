               ...
               <div class="wrap">
                ...
                <?php if( have_rows('szczegolowe_info', $featured_case) ): ?>
                    ...
                    <?php if(!empty($klientGamfiOd)) { ?>
                        <li><span>Klient gamfi od: </span><b><?php echo $klientGamfiOd; ?></b></li>
                    <?php } ?>
                ...
                <div class="bottom">
                    <div class="per">
                        <div class="avatar">
                            ...
                            <?php else : ?>
                            <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.667 490.667"><path fill="#c9c9c9" d="M245.333 0C110.059 0 0 110.059 0 245.333s110.059 245.333 245.333 245.333 245.333-110.059 245.333-245.333S380.608 0 245.333 0zm0 469.333c-123.52 0-224-100.48-224-224s100.48-224 224-224 224 100.48 224 224-100.48 224-224 224z"/><path d="M245.333 234.667c-76.459 0-138.667 62.208-138.667 138.667 0 5.888 4.779 10.667 10.667 10.667S128 379.221 128 373.333C128 308.629 180.629 256 245.333 256s117.333 52.629 117.333 117.333c0 5.888 4.779 10.667 10.667 10.667S384 379.221 384 373.333c0-76.458-62.208-138.666-138.667-138.666zM245.333 64c-41.173 0-74.667 33.493-74.667 74.667s33.493 74.667 74.667 74.667S320 179.84 320 138.667 286.507 64 245.333 64zm0 128C215.936 192 192 168.064 192 138.667s23.936-53.333 53.333-53.333 53.333 23.936 53.333 53.333S274.731 192 245.333 192z" fill="#ff7800" /></svg>
                            <?php endif; ?>
                        </div>
