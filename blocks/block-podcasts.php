            ...
            <div class="content-pod">
                ...
                <div class="wraper">
                    ...
                    <?php if(get_field('prowadzacy', get_the_ID())) { ?>
                      <div class="ex-inf">
                      <span>  Prowadzący: <b><?php the_field('prowadzacy', get_the_ID()) ?></b></span>
                      </div>
                        ...
                        <div class="wraper">
                            ...
                            <div class="con  <?php if (!has_post_thumbnail( $post->ID ) ) { echo "con-full"; }?>">
                                ...
                                <?php if(!empty($czasTrwania)) { ?>
                                    <div class="ex-inf">
                                    <span> Czas trwania: <b><?php echo esc_html(  $czasTrwania ); ?></b> </span>
                                    </div>
                                <?php } ?>
                                <?php if(!empty($prwa)) { ?>
                                <div class="ex-inf">
                                <span>  Prowadzący: <b><?php echo esc_html(  $prwa ); ?></b></span>
                                </div>
                                <?php } ?>
                                <a class=" more" href="<?php echo esc_url( $permalink ); ?>"> Słuchaj teraz </a>
                            </div>
                        </div>
                    </div>
                </article>
