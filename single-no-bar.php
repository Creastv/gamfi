    ...
    <article id="page-<?php the_ID(); ?>" class="hentry">
        <?php if (have_posts()) :
            while ( have_posts() ) : the_post(); ?>
                ...
                <div class="entry-post-feature text-center">
